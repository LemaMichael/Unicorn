...
@class AWEAwemePlayInteractionPresenter; @class AWELiveGiftFansEnterView; @class AWELiveInteractViewController; @class AWEPostWorkViewController; @class AWEAwemeDetailTableViewController; @class AWEUserWorkCollectionViewCell; @class AWEAwemePlayInteractionViewController; @class AWEAwemeBaseViewController; @class AWEAppLiveSettingManager; @class AWEAwemePlayVideoViewController; @class AWEProfileImagePreviewView; @class AWEUserPostsDataManager; @class AWEAwemeShareViewController; @class AWELiveTrackEventManager; @class AWEFeedVideoButton; @class AWELiveFreePresentPropertyManager; @class AWELongVideoPlayerInteractionView; @class AWELiveSendGiftController; @class AWELiveCommentInputView; @class AWELiveGiftListDataController; @class AWELikeWorkViewController; @class AWEAppShareSettingManager; @class AWELiveSendGiftPackage; @class AWEAwemeModel; @class AWELiveGiftListViewController; @class AWEUserDetailViewController; @class AWELiveWalletManager; @class AWELiveMyWalletModel; @class AWELiveSetting; @class AWELiveGiftListBottomLandscapeView; @class AWEGrowingTextView; @class AWELiveAudienceViewController; @class AWECommentListViewController; 
