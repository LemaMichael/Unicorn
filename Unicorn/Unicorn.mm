...
@class AWEAwemeBaseViewController; @class AWELiveMyWalletModel; @class AWELikeWorkViewController; @class AWEAwemePlayInteractionViewController; @class AWELongVideoPlayerInteractionView; @class AWELiveSetting; @class AWEAwemeDetailTableViewController; @class AWELiveGiftListViewController; @class AWELiveSendGiftController; @class AWELiveGiftFansEnterView; @class AWEVideoRecorderController; @class AWEGrowingTextView; @class AWEUserDetailViewController; @class AWELiveTrackEventManager; @class AWEAwemePlayInteractionPresenter; @class AWELiveFreePresentPropertyManager; @class AWELiveGiftListDataController; @class AWEAppShareSettingManager; @class AWEAwemeShareViewController; @class AWEUserPostsDataManager; @class AWEUserWorkCollectionViewCell; @class AWELiveAudienceViewController; @class AWEAppLiveSettingManager; @class AWELiveWalletManager; @class AWELiveCommentInputView; @class AWEFeedVideoButton; @class AWEAwemeModel; @class AWEAwemePlayVideoViewController; @class AWELiveGiftListBottomLandscapeView; @class AWECommentListViewController; @class AWELiveSendGiftPackage; @class AWEPostWorkViewController; @class AWEProfileImagePreviewView; @class AWELiveInteractViewController; 
...
#line 1826 "/Users/michael/Unicorn/Unicorn/Unicorn.xm"
