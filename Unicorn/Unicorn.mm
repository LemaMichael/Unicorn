...
#line 153 "/Users/michael/Unicorn/Unicorn/Unicorn.xm"
...
__attribute__((used)) static AWEFeedVideoButton * _logos_method$_ungrouped$AWEAwemePlayInteractionViewController$downloadButton(AWEAwemePlayInteractionViewController * __unused self, SEL __unused _cmd) { return (AWEFeedVideoButton *)objc_getAssociatedObject(self, _logos_method$_ungrouped$AWEAwemePlayInteractionViewController$downloadButton); }; __attribute__((used)) static void _logos_method$_ungrouped$AWEAwemePlayInteractionViewController$setDownloadButton(AWEAwemePlayInteractionViewController * __unused self, SEL __unused _cmd, AWEFeedVideoButton * rawValue) { objc_setAssociatedObject(self, _logos_method$_ungrouped$AWEAwemePlayInteractionViewController$downloadButton, rawValue, OBJC_ASSOCIATION_RETAIN_NONATOMIC); }
...
static UICollectionViewCell * _logos_method$_ungrouped$AWEPostWorkViewController$collectionView$cellForItemAtIndexPath$(_LOGOS_SELF_TYPE_NORMAL AWEPostWorkViewController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, UICollectionView * arg1, NSIndexPath * arg2) {
    ...
    AWEUserWorkCollectionViewCell *myCell = (AWEUserWorkCollectionViewCell *)_logos_orig$_ungrouped$AWEPostWorkViewController$collectionView$cellForItemAtIndexPath$(self, _cmd, arg1, arg2);
    myCell.isMine = YES;
...
__attribute__((used)) static UILabel * _logos_method$_ungrouped$AWEUserDetailViewController$bdayLabel(AWEUserDetailViewController * __unused self, SEL __unused _cmd) { return (UILabel *)objc_getAssociatedObject(self, _logos_method$_ungrouped$AWEUserDetailViewController$bdayLabel); }; __attribute__((used)) static void _logos_method$_ungrouped$AWEUserDetailViewController$setBdayLabel(AWEUserDetailViewController * __unused self, SEL __unused _cmd, UILabel * rawValue) { objc_setAssociatedObject(self, _logos_method$_ungrouped$AWEUserDetailViewController$bdayLabel, rawValue, OBJC_ASSOCIATION_RETAIN_NONATOMIC); }
__attribute__((used)) static UILabel * _logos_method$_ungrouped$AWEUserDetailViewController$createdLabel(AWEUserDetailViewController * __unused self, SEL __unused _cmd) { return (UILabel *)objc_getAssociatedObject(self, _logos_method$_ungrouped$AWEUserDetailViewController$createdLabel); }; __attribute__((used)) static void _logos_method$_ungrouped$AWEUserDetailViewController$setCreatedLabel(AWEUserDetailViewController * __unused self, SEL __unused _cmd, UILabel * rawValue) { objc_setAssociatedObject(self, _logos_method$_ungrouped$AWEUserDetailViewController$createdLabel, rawValue, OBJC_ASSOCIATION_RETAIN_NONATOMIC); }
...
static UITableViewCell * _logos_method$_ungrouped$AWEAwemeDetailTableViewController$tableView$cellForRowAtIndexPath$(_LOGOS_SELF_TYPE_NORMAL AWEAwemeDetailTableViewController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, UITableView * tableView, NSIndexPath * indexPath){
    AWEAwemeDetailTableViewCell *myCell = (AWEAwemeDetailTableViewCell *)_logos_orig$_ungrouped$AWEAwemeDetailTableViewController$tableView$cellForRowAtIndexPath$(self, _cmd, tableView, indexPath);
...
static UICollectionViewCell * _logos_method$_ungrouped$AWELikeWorkViewController$collectionView$cellForItemAtIndexPath$(_LOGOS_SELF_TYPE_NORMAL AWELikeWorkViewController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, UICollectionView * arg1, NSIndexPath * arg2) {
    AWEUserWorkCollectionViewCell *myCell = (AWEUserWorkCollectionViewCell *)_logos_orig$_ungrouped$AWELikeWorkViewController$collectionView$cellForItemAtIndexPath$(self, _cmd, arg1, arg2);
